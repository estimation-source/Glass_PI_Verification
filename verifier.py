...
# src/verifier.py
#
# GLOBAL MULTI-PASS BEST-FIT VERIFICATION ENGINE
#
# ==========================================================
...
def normalize_text(val: Any) -> str:
    """Clean string for uniform matching."""
...
# ==========================================================
# GLASS SPECIFICATION MATCHING LOGIC
# ==========================================================
...
def check_glass_spec_match(
    ...
    # Required:
    #
    # Excel -> 5MM + REFLECTIVE + TOUGHENED
    # PDF   -> 5MM + REF
    #
    # ======================================================
    ...
    # ======================================================
    # 3. NORMAL GLASS TYPE KEYWORD VERIFICATION
    #
...
# ==========================================================
# MULTI-PASS PRIORITY VERIFICATION ENGINE
# ==========================================================
...
def verify_pi_against_excel(
    ...
    """
    Verifies Excel vs PDF using Global Multi-Pass
    Best-Fit Match logic regardless of row positions
    or sequence order.
    """
    ...
    matched_pdf_for_excel: Dict[int, Any] = {
        i: None
    ...
    # PASS 5
    #
    # WINDOW CODE REMAINING FALLBACK
    # ======================================================
    ...
    # ======================================================
    # CONSTRUCT FINAL VERIFICATION REPORT
    # ======================================================
